...
def executar_merge_sort_hibrid(start, stop, step, n_iterations, LIMITE_ALEATORIO, non_global_LIMITE, name_file):
    file = open(name_file, "w+")
    
    global LIMITE
    LIMITE = non_global_LIMITE
    
    file.write("MergeSortHibrid: start=" + str(start) + ", stop=" + str(stop) + ", step=" + str(step) + ", n_iterations=" + str(n_iterations) + ", Limite Insertion/merge=" + str(LIMITE))
    file.write("\n")
